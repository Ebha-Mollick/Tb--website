...
function Footer() {
  return (
    <div className=' gap-2 w-full h-screen bg-zinc-900 p-20 '>
      <div className=" w-100 h-1/4 mt-10">
        <div className='heading '>
          <h1 className='flex justify-center text-[8vw] font-bold uppercase leading-none -mb-5'>Technical Board </h1>
          {/* <h1 className='text-[8vw] font-bold uppercase leading-none -mb-5'>Opening</h1> */}
        </div>
      ...
      <div className='border-2 border-white-400 w-full h-1/4'>
        img of tb logo
      </div>
      <div className='flex justify-between mt-32 w-full'>
      <div>
        <h1 className='text-[1.5vw] font-semibold  leading-none overflow-hidden mb-10' >Get to know us</h1>
        <div className="dets font-light ">
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">home</a>
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">anout us</a>  
        </div>
      </div>
      
      <div>
        <h1 className='text-[1.5vw] font-semibold  leading-none overflow-hidden mb-10' >Follow us on</h1>
        <div className="dets  font-light">
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">instagram</a>
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">facebook</a>  
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">linkedin</a>  
        </div>
      </div>
      <div>
        <h1 className='text-[1.5vw] font-semibold  leading-none overflow-hidden mb-10' >Site map</h1>
        <div className="dets">
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">Home</a>
          <a className="block text-[1vw] font-['Neue Montreal'] uppercase"href="#">event details</a>  
        </div>
      </div>
      </div>
